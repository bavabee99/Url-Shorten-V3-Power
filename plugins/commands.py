...
user_commands = ["api", "shortener_api", "header", "footer", "username", "banner_image", "base_site", "me"]
avl_web = ["tamizhmasters.com", "droplink.co", "gplinks.in", "tnlink.in", "za.gl", "du-link.in", "viplink.in", "shorturllink.in", "shareus.in", "earnspace.in",]
